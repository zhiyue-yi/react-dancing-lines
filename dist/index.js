...
function DancingLines(props) {
    ...
    var canvasRef = react_26(null);
    var targetRef = react_26({ x: 0, y: 0 });
    var tendrilsRef = react_26([]);
    var runningRef = react_26(false);
    var frameRef = react_26(0);
